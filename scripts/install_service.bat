...
:: ============================================================
::  MALINALCO RENDER - Instalar servicio Windows + kiosko
::  Requiere: NSSM en PATH, Node.js v20+, Chrome instalado
::  Ejecutar como administrador
:: ============================================================

set "SERVICE_NAME=MalinalcoNode"
set "PROJECT_DIR=%~dp0.."
...
title Malinalco Render - Instalador de servicio

echo.
echo ============================================================
echo   MALINALCO RENDER - Instalando servicio
echo ============================================================
...
nssm set !SERVICE_NAME! DisplayName "Malinalco Render (Node)"
nssm set !SERVICE_NAME! Description "Dashboard 3D Acopinalco - monitoreo ambiental tiempo real"
...
copy /Y "%~dp0open_kiosk.bat" "!STARTUP_FOLDER!\MalinalcoKiosk.bat" >nul 2>&1
if %errorlevel% equ 0 (
